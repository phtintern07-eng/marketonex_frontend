document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Parts Database - Populated from Marketplace API
    const partsDatabase = {};

    // --- Load Products from Marketplace API ---
        ...
        if (parts.length === 0) {
            ...
            selectionGrid.innerHTML = `
                <div style="text-align: center; padding: 3rem; color: var(--text-secondary);">
                    ...
                    <p style="margin-bottom: 1.5rem;">Add products with component type "${catId}" in the marketplace first.</p>
                    <a href="marketplace.html" class="btn" style="display: inline-block; padding: 0.75rem 1.5rem; background: var(--primary); color: white; text-decoration: none; border-radius: 8px;">
                        <i class="fas fa-plus"></i> Go to Marketplace
                    </a>
                </div>
            `;
        } else {
