...
function updateUIWithUser(user) {
    ...
    // 2. Marketplace Header Profile Elements
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Note: If drawer doesn't exist, the page-specific JS (e.g., marketplace.js) handles the button
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                // Set login flag for marketplace
                localStorage.setItem('vendorLoggedIn', 'true');
                ...
                if (redirect === 'addProduct') {
                    // Redirect to marketplace with openAddProduct parameter
