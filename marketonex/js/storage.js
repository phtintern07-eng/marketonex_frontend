...
const MarketonexStorage = {
    ...
    init() {
        return new Promise((resolve, reject) => {
            ...
            request.onerror = (event) => {
                console.error('MarketonexDB error:', event.target.error);
            ...
            request.onsuccess = (event) => {
                ...
                console.log('MarketonexDB Initialized');
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                if (this.useLocalStorage) {
                    const data = localStorage.getItem('marketonexProducts');
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                if (this.useLocalStorage) {
                    ...
                    try {
                        localStorage.setItem('marketonexProducts', JSON.stringify(products));
                        resolve(product.id);
                    } catch (e) {
    ...
    _migrateFromLocalStorage() {
        return new Promise((resolve) => {
            const localData = localStorage.getItem('marketonexProducts');
            ...
            try {
                ...
                countReq.onsuccess = () => {
                    if (countReq.result === 0) {
                        ...
                        // localStorage.removeItem('marketonexProducts');
                    }
                    resolve();
                };
            } catch (e) {
...
// document.addEventListener('DOMContentLoaded', () => MarketonexStorage.init());
